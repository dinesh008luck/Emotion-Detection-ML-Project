...
logger = logging.getLogger('data_injection_loger')
...
def main():
    try:
        ...
        train_data, test_data = train_test_split(df_final, test_size=test_size, random_state=50)
        ...
        logger.error('Fail to complete the data injection error in main')
        raise
